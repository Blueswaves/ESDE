...
exports.processUpdateOneDesign = async (req, res, next) => {
    ...
    //SOLUTION
    //========================================================================
    let inputs = req.body.designTitle;
    let designTitle = validator.escape(inputs);
    let input = req.body.designDescription;
    let designDescription = validator.escape(input);
    try {
