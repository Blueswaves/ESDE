...
module.exports.checkForValidUserRoleUser = (req, res, next) => {
    ...
    //The user id information is inserted into the request.body.userIds
        ...
        if (typeof req.headers.authorization !== "undefined") {
            ...
            jwt.verify(token, config.JWTKey, (err, data) => {
                ...
                if (err) {
                    ...
                    req.body.role_name = data.role_name;
                    console.log("data id =" + req.body.userId + "role name = " + req.body.role_name);
                    next();
                }
            })
