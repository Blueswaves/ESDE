...
module.exports.getFileData = (userId, pageNumber, search) => {
    ...
    if ((search == '') || (search == null)) {
        ...
        //ERROR(DEMO)
        //========================================================================
        // var designFileDataQuery = `SELECT file_id,cloudinary_url,design_title,design_description 
    ...
    return new Promise((resolve, reject) => {
        ...
        pool.getConnection((err, connection) => {
            if (err) {
                ...
                connection.query(designFileDataQuery, [userId, userId, search, offset, limit,], (err, results) => {
                    if (err) {
                        //========================================================================
                        //SOLUTION
                        //========================================================================
